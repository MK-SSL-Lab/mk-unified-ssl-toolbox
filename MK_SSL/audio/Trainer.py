...
class Trainer:
    ...
    def _train_cola(
                self, train_loader, optimizer, max_epochs: int, start_epoch: int = 0
            ) -> None:
                """
                ...
                for epoch in range(start_epoch, max_epochs):
                    ...
                    for batch in pbar:
                        # COLA expects two augmented views of the audio
                        # Assuming batch contains 'view0' and 'view1' (e.g., log-mel spectrograms)
                        # These would be generated by COLAAudioTransform in the dataset's __getitem__
                        view0 = batch["view0"].to(self.device)
